# Generated by Django 4.2.13 on 2024-07-16 11:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('department', models.CharField(choices=[('CSE(Regular)', 'CSE(R)'), ('CSE(Honors)', 'CSE(H)')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('CSE(Regular)', 'CSE(R)'), ('CSE(Honors)', 'CSE(H)')], max_length=50)),
